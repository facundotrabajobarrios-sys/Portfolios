...
class EstatePropertyOffer(models.Model):
    ...
    date_deadline = fields.Date(
        ...
        #En este caso, date_deadline depende de create_date y validity, y si el usuario modifica date_deadline, 
        #queremos que se actualice validity en consecuencia.
    ...
    def _inverse_date_deadline(self):
        for record in self:
            #si la fecha de creación y la fecha límite están presentes, se calcula la validez restando la fecha de creación a la fecha límite. Si no, se establece como 0.
    ...
    def action_accept(self):
        for record in self:
            ...
            #- (operador de resta) → "Quita esto del conjunto"
            #record La oferta actual (la que se está aceptando)
            ...
            record.property_id.write({
                ...
                #selling_price significa precio venta
